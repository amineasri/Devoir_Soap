...
public class ObjectFactory {
    ...
    private static final QName _GetProduct_QNAME = new QName("http://webservices/", "getProduct");
    private static final QName _GetProductResponse_QNAME = new QName("http://webservices/", "getProductResponse");
    private static final QName _Product_QNAME = new QName("http://webservices/", "product");
    private static final QName _ProductList_QNAME = new QName("http://webservices/", "productList");
    private static final QName _ProductListResponse_QNAME = new QName("http://webservices/", "productListResponse");
    private static final QName _SellingPrice_QNAME = new QName("http://webservices/", "sellingPrice");
    private static final QName _SellingPriceResponse_QNAME = new QName("http://webservices/", "sellingPriceResponse");
     ...
     */
    @XmlElementDecl(namespace = "http://webservices/", name = "getProduct")
     ...
     */
    @XmlElementDecl(namespace = "http://webservices/", name = "getProductResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://webservices/", name = "productList")
     ...
     */
    @XmlElementDecl(namespace = "http://webservices/", name = "productListResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://webservices/", name = "sellingPrice")
     ...
     */
    @XmlElementDecl(namespace = "http://webservices/", name = "sellingPriceResponse")
