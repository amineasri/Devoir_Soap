 ...
 * 
 */
@WebServiceClient(name = "ProductWS", targetNamespace = "http://webservices/", wsdlLocation = "http://localhost:8088/?wsdl")
    ...
    extends Service
{
    ...
    private static final QName PRODUCTWS_QNAME = new QName("http://webservices/", "ProductWS");
    ...
    public ProductWebService getProductWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservices/", "ProductWebServicePort"), ProductWebService.class, features);
    }
